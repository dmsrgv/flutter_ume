...
class _ColorButtonState extends State<ColorButton> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Material(
          ...
          shape: widget.boxShape == BoxShape.circle ? const CircleBorder() : const RoundedRectangleBorder(),
          child: Container(
            width: widget.size,
            height: widget.size,
  ...
  Future<Color> showColorPicker(BuildContext rootContext, Offset offset) async {
    ...
    Overlay.maybeOf(rootContext)?.insert(pickerOverlay!);
  ...
  void didChangeMetrics() {
    ...
    final keyboardTopPixels = view.physicalSize.height - view.viewInsets.bottom;
